...
const CareCardSection = () => {
  ...
  return (
    <Box>
      ...
      {/* <CustomSubHeading fontWeight={500} fontSize={{ base: "16px", md: "32px" }} textAlign="center"  >
        Culture is how we create a {" "}
        <Text as="span" fontWeight={600} position="relative" display="inline-block"> safe, supportive space </Text>
      </CustomSubHeading> */}
