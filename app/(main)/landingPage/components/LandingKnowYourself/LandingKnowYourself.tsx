...
import CardComponent3 from "../../../../component/common/CardComponent3/CardComponent3";
...
const KnowYourselfSection = () => {
  const [isOpen, setIsOpen] = useState(false);  const [activeCard, setActiveCard] = useState(0); // Default to the first card
