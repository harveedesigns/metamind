...
const ReviewSection: React.FC<ReviewSectionProps> = ({ data = [] }) => {
  ...
  return (
    <Box>
      ...
      <Flex direction={['column', 'row']} w="full" gap={{ base: 9, lg: 2 }} maxW={{ base: "90%", lg: '85%' }} mt={8} mx={'auto'} justify={{ lg: 'space-between' }}>
        {/* Left scrollable section */}
        <Box w={['full', '30%']} h="200px" overflowY="auto" pr={2} className='customScrollBar'>
        ...
        <Box w={{ base: '100%', lg: '60%' }} mx={{ base: 'auto', lg: '0' }}>
          {selectedReview ? (
            <Flex direction="column" align="flex-start">
              <Flex align="center" mt={2} justifyContent={{ base: "center", lg: "flex-start" }} w="full">
